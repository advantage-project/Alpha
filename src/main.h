...
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN); //Darksend will be deleted in future iterations.

static const int64_t STATIC_POS_REWARD = 1 * COIN; //reward of 1 USDA + Fees
...
static const unsigned int MAX_BLOCK_SIZE = 40000;//40kB // 50-100 transactions per PoS block 
...
static const int64_t MAX_MONEY = 50010000000 * COIN; 
...
//Masternode call, currently set to: 1,000,000 USDA collateral.
