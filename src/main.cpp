                        ...
                        bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees)
{
...

    {
        ...
        if (fRejectInsaneFee && nFees > MIN_RELAY_TX_FEE * 100000000000) //fee limit in satoshis
            return error("AcceptableInputs: : insane fees %s, %d > %d",
                         hash.ToString(),
                         nFees, MIN_RELAY_TX_FEE * 100000000000);
                         ...
                         bool* pfMissingInputs, bool fRejectInsaneFee, bool isDSTX)
{
...

    {
        ...
        if (fRejectInsaneFee && nFees > txMinFee * 100000000000) //fee limit in satoshis
            return error("AcceptableInputs: : insane fees %s, %d > %d",
                         hash.ToString(),
                         nFees, MIN_RELAY_TX_FEE * 100000000000);
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) {
        nSubsidy = 163472364 * COIN; // premine
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
	...
	if (pindex->nHeight > 1 && pindex->nHeight % 100 == 0) {nReward += 10000000000000; //TreasuryinSats
}
